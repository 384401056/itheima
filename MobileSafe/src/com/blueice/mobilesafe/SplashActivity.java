			...
			new AsyncTask<String, Integer, Message>() {
				...
				protected Message doInBackground(String... params) {
					...
					try {
						...
						InputStream is = clientUtils.sendRequest(ConstValue.URI, params[0]);
		...
		dialog.setPositiveButton("立刻升级", new OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
					...
					finalHttp.download(version.getApkurl(), 
							...
							new AjaxCallBack<File>() {
								...
								public void onFailure(Throwable t, int errorNo,String strMsg) {
									t.printStackTrace();
									PromptManager.showToast(getApplicationContext(), "下载失败。");
								...
								public void onSuccess(File t) {
									PromptManager.showToast(getApplicationContext(), "下载成功。");
									super.onSuccess(t);
					...
					PromptManager.showToast(getApplicationContext(), "没有找到SD卡，请安装好再试。");
				}
